...
# Average CV score on the training set was: -222.30242914141408
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=SGDRegressor(alpha=0.0, eta0=1.0, fit_intercept=True, l1_ratio=0.0, learning_rate="constant", loss="squared_loss", penalty="elasticnet", power_t=0.5)),
