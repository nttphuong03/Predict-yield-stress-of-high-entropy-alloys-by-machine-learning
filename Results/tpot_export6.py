...
# Average CV score on the training set was: -226.5064100987654
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=False, max_features=0.8, min_samples_leaf=6, min_samples_split=16, n_estimators=100)),
